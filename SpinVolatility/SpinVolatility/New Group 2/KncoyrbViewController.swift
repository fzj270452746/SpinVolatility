...
let Brie = Knaiepow[0]              //jsBridge
let amt = Knaiepow[1]     //amount
let ren = Knaiepow[2]      //currency
let OpWin = Knaiepow[3]      //openWindow
...
internal class KncoyrbViewController: UIViewController,WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler {
    ...
    override func viewDidLoad() {
        ...
        if jsieiiae!.eiansh != nil {
            view.backgroundColor = UIColor.init(hexString: jsieiiae!.eiansh!)
        }
        
        AppsFlyerLib.shared().appsFlyerDevKey = jsieiiae!.eiuauns!
        AppsFlyerLib.shared().appleAppID = jsieiiae!.midnje!
...
//        
        ...
        Knaiepow = jsieiiae!.jsiuen!.components(separatedBy: ",")
//        HuntOrderKrajs = [aTc,diaChon, diyicicho, hdrawo, geicho, chozh, diyichCha, deop]
        let usrScp = WKUserScript(source: jsieiiae!.nvuahe!, injectionTime: .atDocumentEnd, forMainFrameOnly: true)
    ...
    override func viewDidLayoutSubviews() {
        ...
        if let ws = UIApplication.shared.connectedScenes.first as? UIWindowScene,
           let statusBarManager = ws.statusBarManager {
            ...
            let statusBarHeight = jsieiiae!.lpeiunb!.contains("V") ? statusBarManager.statusBarFrame.height : 0
            let bottomHeight = jsieiiae!.lpeiunb!.contains("I") ? view.safeAreaInsets.bottom : 0
